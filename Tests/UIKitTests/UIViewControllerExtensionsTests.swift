...
final class UIViewControllerExtensionsTests: XCTestCase {
    ...
    func testAddNotificationObserver() {
        ...
        viewController.re.addNotificationObserver(name: notificationIdentifier, selector: selector)
    ...
    func testIsVisible() {
        ...
        XCTAssertFalse(viewController.re.isVisible)
    }
    ...
    func testRemoveNotificationObserver() {
        ...
        let selector = #selector(MockNotificationViewController.testSelector)
        viewController.re.addNotificationObserver(name: notificationIdentifier, selector: selector)
        viewController.re.removeNotificationObserver(name: notificationIdentifier)
        NotificationCenter.default.post(name: notificationIdentifier, object: nil)
    ...
    func testRemoveNotificationsObserver() {
        ...
        let selector = #selector(MockNotificationViewController.testSelector)
        viewController.re.addNotificationObserver(name: notificationIdentifier, selector: selector)
        viewController.re.removeNotificationsObserver()
        NotificationCenter.default.post(name: notificationIdentifier, object: nil)
        XCTAssertFalse(viewController.notificationFired)
    }
    ...
    func testInstantiate() {
        ...
        let myViewController = TestViewController.re.instantiate(from: storyboard,
        ...
        let identifiedViewController = TestViewController.re.instantiate(from: storyboard,
    ...
    func testShowAlert() {
        ...
        let alertController = viewController.re.showAlert(
            title: title,
            message: message,
    ...
    func testAddChildViewController() {
        ...
        parentViewController.re.addChildViewController(childViewController, toContainerView: parentViewController.view)
    ...
    func testRemoveChildViewController() {
        ...
        childViewController.re.removeViewAndControllerFromParentViewController()
    ...
    func testPresentPopover() {
        ...
        presentingViewController.re.presentPopover(
            popover,
