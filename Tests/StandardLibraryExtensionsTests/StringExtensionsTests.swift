...
//    }
    ...
    func testSubscript() {
        ...
        XCTAssertNil(str.re[11...12])

        let oneCharStr = "a"
        XCTAssertEqual(oneCharStr.re[0..<0], "")
        XCTAssertEqual(oneCharStr.re[0..<1], "a")
        XCTAssertNil(oneCharStr.re[0..<2])
        XCTAssertEqual(oneCharStr.re[1..<1], "")
        XCTAssertNil(oneCharStr.re[1..<2])

        XCTAssertEqual(oneCharStr.re[0...0], "a")
        XCTAssertNil(oneCharStr.re[0...1])
        XCTAssertNil(oneCharStr.re[0...2])
        XCTAssertNil(oneCharStr.re[1...1])
        XCTAssertNil(oneCharStr.re[1...2])

        // Empty string
        XCTAssertEqual("".re[0..<0], "")
        XCTAssertNil("".re[0..<1])
        XCTAssertNil("".re[1..<1])
        XCTAssertNil("".re[1..<2])
        XCTAssertNil("".re[2..<3])
