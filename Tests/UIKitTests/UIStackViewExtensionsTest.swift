...
final class UIStackViewExtensionsTest: XCTestCase {
    ...
    func testInitWithViews() {
        let view1 = UIView()
        let view2 = UIView()
        var stack = UIStackView.re(arrangedSubviews: [view1, view2], axis: .horizontal)
        ...
        XCTAssertEqual(UIStackView.re(arrangedSubviews: [view1, view2], axis: .vertical).axis, .vertical)
        XCTAssertEqual(UIStackView.re(arrangedSubviews: [view1, view2], axis: .vertical, alignment: .center).alignment,
                       .center)

        XCTAssertEqual(UIStackView.re(arrangedSubviews: [view1, view2], axis: .vertical,
                                   distribution: .fillEqually).distribution, .fillEqually)

        XCTAssertEqual(UIStackView.re(arrangedSubviews: [view1, view2], axis: .vertical, spacing: 16.0).spacing, 16.0)

        stack = UIStackView.re(arrangedSubviews: [view1, view2], axis: .vertical, spacing: 16.0,
    ...
    func testAddArrangedSubviews() {
        ...
        stack.re.addArrangedSubviews([view1, view2])
        XCTAssertEqual(stack.arrangedSubviews.count, 2)
    }
    ...
    func testRemoveArrangedSubviews() {
        ...
        stack.re.removeArrangedSubviews()
    ...
    func testSwap() {
        ...
        stack.re.swap(view1, view3)
        stack.re.swap(view2, view5)
