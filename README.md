...
## Usage
[Link of Documents build by DocC](https://swiftpackageindex.com/reers/ReerKit/1.2.4/documentation/reerkit)
...
<pre><code class="ogdl language-ogdl">github "ReerKit/ReerKit" ~> 1.2.4
</code></pre>
</details>
...
let package = Package(
    ...
    targets: [],
    dependencies: [
        .package(url: "https://github.com/reers/ReerKit.git", from: "1.2.4")
    ]
)
</code></pre>
