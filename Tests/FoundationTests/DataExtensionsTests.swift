...
final class DataExtensionsTests: XCTestCase {
    ...
    func testRSA() {
        ...
        do {
            ...
            let encrypted1 = original.re.utf8Data!.re.rsaEncrypt(with: publicKey)
            let ret1 = encrypted1!.re.rsaDecrypt(with: privateKey)!.re.utf8String!
            XCTAssertEqual(original, ret1)
            
            let encrypted2 = original.re.utf8Data!.re.rsaSigned(with: privateKey)
            let ret2 = encrypted2!.re.rsaVerified(with: publicKey)!.re.utf8String!
