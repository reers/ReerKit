...
/// ReerKit: Asserts that the RGBA values of two `Color`s are equal within a certain accuracy.
/// - Parameters:
///   - expression1: A `Color`.
///   - expression2: A `Color`.
...
public func XCTAssertEqual(_ expression1: @autoclosure () throws -> REColor,
                           _ expression2: @autoclosure () throws -> REColor,
                           accuracy: CGFloat,
...
/// ReerKit: Asserts that the RGBA values of two `CGAffineTransform`s are equal within a certain accuracy.
/// - Parameters:
